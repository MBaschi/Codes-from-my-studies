// KITT 2.0 variable delay+ dynamic refresh : RC0 come il pin da cui ricevo il nuovo dato
// io ho capito questo: il cronometro ,se acceso, continua a contare ma io ti mostro il suo valore solo quando ho un ingresso
// LCD SETTING
