#utilizzo decolle
#uno shallow network con lr=e-5 non funziona acccuracy 50%
...
if 1: #control variable
    ...
    SLAYER=False #se falso uso decolle
    SHOW_SIGNAL_IMPORT=0
    SHOW_LEARNING=1
    Show_learn_interval=600
...
if 1: #various function   
    ...
    def plot_network(Network,obj):
       ...
       Network.synapse[N_of_layer-3].show(layer_number=N_of_layer-2,interactive= False,start_blank=False)
...
if 1: # network creation 
    ...
    meanW=0
    varW=(no.LIF_neuron.treshold/no.LIF_neuron.alfa)/5
