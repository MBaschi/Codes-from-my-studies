#include <stdio.h>
#include <stdlib.h> //definizione di Malloc
...
int main() {
    ...
    ptrList lista1 = NULL;  //inizializzazione
    ptrList2 lista2 = NULL; //inizializzazione
    
    int a,b;
    
    do{
        printf("Inserisci due valori interi per nodo (-1 per uscire)->");
        scanf("%d %d",&a,&b);
        if ((a!=-1) && (b!=-1))
